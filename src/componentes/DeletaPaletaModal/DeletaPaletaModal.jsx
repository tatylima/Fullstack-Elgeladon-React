  ...
  return (
    <Modal closeModal={closeModal}>
      <div className="DeletaPaletaModal">
        ...
        <img className="DeletaPaletaModal__foto"src={paletaParaDeletar.foto}alt={paletaParaDeletar.titulo}/>

        <br />

        <div>
          <button onClick={() => handleDelete(paletaParaDeletar)}className="DeletaPaletaModal__confirmar">
            {" "}
            Confirmar{" "}
          </button>
